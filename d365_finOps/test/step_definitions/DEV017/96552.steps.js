...
//Data model
const DATA_DD_96552 = require('../../data/DEV017/96552.json');


When(/^96552 User navigate to All Customer$/, async () => {
  await PAGE_FINOPSHOME.navigateTo(ALL_CUSTOMER);
});
Then(/^96552 Verify can create new DD$/, async () => {
    ...
    await PAGE_FTI.Verify_Data_Of_New_DD(ID);
