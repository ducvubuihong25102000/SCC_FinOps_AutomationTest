...
When(/^When 105605 User navigate to Supplier payment journal$/, async () => {
  await pageFOHomePage.navigateTo(SUPPLIER_PAYMENT_JOURNAL);
});

Then(/^Then 105605 User create new Supplier Payment journal$/, async () => {
...
Then(/^Then 105605 Verify the payment voucher$/, async () => {
