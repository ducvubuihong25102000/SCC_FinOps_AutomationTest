...
When(/^91160 User navigate to General Journal$/, async () => {
  await pageFOHomePage.navigateTo(GENERAL_JOURNAL);
});
Then(/^91160 Verify user in which Legal Entity$/, async () => {
...
Then(
  /^91160 Verify user able to create General Journal and Posted$/,
  async () => {
...
Then(/^91160 Verify the value of the Voucher page$/, async () => {
