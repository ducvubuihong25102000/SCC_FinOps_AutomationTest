Feature: LoginUser
    ...
    Scenario: Verify as [SCC User Role] is able to logged in to ProjOps homepage
        Given User is on SCC ProjecOps Authentication page 
        When User enter valid projectops user credential and Click Submit
        Then Verify that system is logged in to ProjOps homepage
