...
exports.config = {
  ...
  specs: [
    ...
    `${process.cwd()}/test/features/MRCycle3_SIT5/LE3300/CashAndBank.feature`,
    `${process.cwd()}/test/features/MRCycle3_SIT5/LE3300/GeneralLedger.feature`,
    `${process.cwd()}/test/features/MRCycle3_SIT5/LE3300/VATScen.feature`,
  ],
  // Patterns to exclude.
  exclude: [
  ...
  cucumberOpts: {
    ...
    require: [
      ...
      './test/step_definitions/MRegCycle3_SIT5/*p2p.steps.js',
    ],
